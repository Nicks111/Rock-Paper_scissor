var Display = {
    transitionMenuToGame: function() {
      $("#" + game.player_character).effect(
        ...
        1500,
        function() {
          $("#alert-box").slideDown(2000);
          $("#character-choices").hide(300, function() {
            if ($(window).width() < 800) {
              $("#alert-box").hide();
            } else {
    ...
    showKeyboardInstructions: function() {
      $("#alert-box").html(
        "Choose <u>R</u>ock, <u>P</u>aper or <u>S</u>cissors!"
      );
  ...
  Game.prototype = {
    ...
    addPoints: function() {
      if (
        (this.player_hand === "rock" && this.computer_hand === "scissors") ||
